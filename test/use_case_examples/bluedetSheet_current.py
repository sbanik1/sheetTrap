...
f_sph1 = 300                                    # Focal length of first lens [mm]
f_sph2 = 200                                    # Focal length of first lens [mm]
# Array Parameters ############################################################
Nx = 2**7
Ny = 2**7
Nz = 5
...
# Generating Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[E2, X2, Y2] = OE.CylLensAction(E1,X1,Y1,k,f_cyY,FocusingAxis = 'Y',FocusedAxis = 'None')
I2 = GB.BeamInt(E2,P)
# Generating Fits %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
I2 = I2.astype(float)
...
# %% Spherical lens f_sph1 ####################################################
# Generating Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%                             
[E3, X3, Y3] = OE.SphLensAction(E2,X2,Y2,k,f_sph1,FocussedAxis ='Y')
I3 = GB.BeamInt(E3,P)
# Generating Fits %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
I3 = I3.astype(float)
...
figure = plotGaussianBeam(3,X3,Y3,I3,I3_fit,params3,4,4)
...
# %% Final Lens f_sph2 ###################################################
# Generating Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[E5, X5, Y5] = OE.SphLensAction(E4,X4,Y4,k,f_sph2,FocussedAxis ='XY')
I5 = GB.BeamInt(E5,P)
figure = plotGreenSheet(5,X5,Y5,I5,f_sph2,0.5*10**3,2*10**1)
cwd = os.getcwd()
os.chdir(startUp.saveDir)
figure.set_size_inches(10, 7)
...
# Generating Data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%                             
[E6, X6, Y6] = OE.SphLensAction(E3,X3,Y3,k,f_sph2,FocussedAxis ='XY')
I6 = GB.BeamInt(E6,P)
# Generating Fits %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
I6 = I6.astype(float)
p0 = [np.max(I6),0,0,w0,w0]
[params6,_] = optimize.curve_fit(GB.GaussBeamFit, [X6,Y6], I6.ravel(),p0 = p0)
I6_fit = GB.GaussBeamFit((X6,Y6),*params6).reshape(Ny,Nx)
plotGaussianBeam(6,X6,Y6,I6,I6_fit,params6,1,0.03)
